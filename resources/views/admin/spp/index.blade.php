...
<div class="sm:ml-64">
   <div class="p-4 py-10 mt-14">
    <h1 class="mb-2 text-gray-700 font-bold text-4xl">Data Spp</h1>
...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex-auto mx-auto max-w-screen-xl">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Nominal Perbulan</th>
            ...
            {{-- PAGINATION --}}
        {{ $spp->links('vendor.pagination.tailwind') }}
        </div>
    </div>
    </section>
